...
class _PersonalInfoApi implements PersonalInfoApi {
  ...
  @override
  Future<PersonalInfoResponseModel> createProfile(
    ...
    _data.addAll(body);
    final _options = _setStreamType<PersonalInfoResponseModel>(
    ...
    late PersonalInfoResponseModel _value;
    try {
      _value = PersonalInfoResponseModel.fromJson(_result.data!);
    } on Object catch (e, s) {

...
class TripGroupWidget extends StatelessWidget {
  TripGroupWidget({super.key, this.tripGroup, this.scrollController,this.tripCardType = TripCardType.homeScreenType});
          ...
          children: [
            ...
            ListView.separated(
              ...
              itemBuilder: (context, ind) {
                return TripCard(model: tripGroup?[index].trips?[ind],date: tripGroup?[index].date ?? "",tripCardType: tripCardType,);
              },
